            ...
            <div className="flex-1 py-4 sm:py-8">
              ...
              <div className="px-4 sm:px-8 mt-8 sm:mt-12">
                <Link to="/contact">
                  <button
                    onClick={closeSidebar}
                    className={`w-full px-6 sm:px-8 py-3 sm:py-4 rounded-2xl transition-all duration-300 text-lg sm:text-xl font-medium ${
                      isActiveLink("/contact")
                        ? "bg-gradient-to-l from-[#C848C1] to-[#54A6F9] text-white"
                        : "bg-gradient-to-r from-[#C848C1] to-[#54A6F9] text-white hover:shadow-lg transform hover:scale-105"
                    }`}
                  >
                    Contact
                  </button>
